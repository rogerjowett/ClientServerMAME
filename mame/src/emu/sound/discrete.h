...
public:
	...
	inline void deleteAtIndex(int index)
	{
...
public:
	...
	inline bool dev_interface(discrete_step_interface *&intf) const { intf = m_step_intf; return (intf != NULL); }
	inline bool dev_interface(discrete_input_interface *&intf) const { intf = m_input_intf; return (intf != NULL); }
	inline bool dev_interface(discrete_sound_output_interface *&intf) const { intf = m_output_intf; return (intf != NULL); }
