...
void input_init(running_machine *machine)
{
	...
	if(netServer)
	{
		netServer->createMemoryBlock((unsigned char*)machine->input_data->code_pressed_memory,sizeof(input_code)*MAX_PRESSED_SWITCHES);
	}
	if(netClient) 
	{
		netClient->createMemoryBlock((unsigned char*)machine->input_data->code_pressed_memory,sizeof(input_code)*MAX_PRESSED_SWITCHES);
	}
#endif
...
input_device *input_device_add(running_machine *machine, input_device_class devclass, const char *name, void *internal)
{
	...
	if(netServer) 
	{
		netServer->createMemoryBlock((unsigned char*)&(device->joymap),sizeof(joystick_map));
		netServer->createMemoryBlock((unsigned char*)&(device->lastmap),sizeof(UINT8));
	}
	if(netClient) 
	{
		netClient->createMemoryBlock((unsigned char*)&(device->joymap),sizeof(joystick_map));
		netClient->createMemoryBlock((unsigned char*)&(device->lastmap),sizeof(UINT8));
	}
#endif
...
void input_device_item_add(input_device *device, const char *name, void *internal, input_item_id itemid, item_get_state_func getstate)
{
	...
	if(netServer) 
	{
		//netServer->createMemoryBlock((unsigned char*)item->internal,sizeof(INT32));
		//netServer->createMemoryBlock((unsigned char*)&(item->current),sizeof(INT32));
		//netServer->createMemoryBlock((unsigned char*)&(item->memory),sizeof(INT32));
		//netServer->createMemoryBlock((unsigned char*)&(item->oncelatch),sizeof(INT32));
		//netServer->createMemoryBlock((unsigned char*)&(item->steadykey),sizeof(INT32));
		//netServer->createMemoryBlock((unsigned char*)&(item->oldkey),sizeof(INT32));
	}
	if(netClient) 
	{
		//netClient->createMemoryBlock((unsigned char*)item->internal,sizeof(INT32));
		//netClient->createMemoryBlock((unsigned char*)&(item->current),sizeof(INT32));
		//netClient->createMemoryBlock((unsigned char*)&(item->memory),sizeof(INT32));
		//netClient->createMemoryBlock((unsigned char*)&(item->oncelatch),sizeof(INT32));
		//netClient->createMemoryBlock((unsigned char*)&(item->steadykey),sizeof(INT32));
		//netClient->createMemoryBlock((unsigned char*)&(item->oldkey),sizeof(INT32));
	}
}
