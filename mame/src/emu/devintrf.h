...
public:
	...
	virtual UINT8 databus_width(int spacenum = 0) const { return (UINT8)(get_config_int(DEVINFO_INT_DATABUS_WIDTH + spacenum) ); }
	virtual UINT8 addrbus_width(int spacenum = 0) const { return (UINT8)(get_config_int(DEVINFO_INT_ADDRBUS_WIDTH + spacenum) ); }
	virtual INT8 addrbus_shift(int spacenum = 0) const { return (INT8)(get_config_int(DEVINFO_INT_ADDRBUS_SHIFT + spacenum) ); }
