...
void deco16ic_pf34_set_gfxbank( running_device *device, int smallInt, int bigInt )
{
	deco16ic_state *deco16ic = get_safe_token(device);

	if (deco16ic->pf34_last_big != bigInt)
	{
		...
		deco16ic->pf34_last_big = bigInt;
	}
	deco16ic->pf34_16x16_gfx_bank = bigInt;
}
