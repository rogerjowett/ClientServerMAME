...
2) Both of you get the rom you are going to play and ClientServerMAME from github
...
7) Have the server start the game like this (USE FULL PATH TO ROM):
vmess.exe (system) -cart (rom) -server
8) Have the clients connect like this (USE FULL PATH TO ROM):
vmess.exe (system) -cart (rom) -client -hostname (hostname)
