...
extern CHAR *astring_from_utf8(const char *utf8string);
...
extern WCHAR *wstring_from_utf8(const char *utf8string);
...
const osd_directory_entry *osd_readdir(osd_directory *dir)
{
	...
	// extract the data
	dir->entry.name = utf8_from_wstring(dir->data.cFileName);
