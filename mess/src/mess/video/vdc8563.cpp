...
*****************************************************************************/
 ...
 vdc8563_state *get_safe_token_vdc8563( running_device *device )
{
	assert(device != NULL);
 ...
 const vdc8563_interface *get_interface_vdc8563( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == VDC8563));
...
{
	vdc8563_state *vdc8563 = get_safe_token_vdc8563(device);
