...
***************************************************************************/
 ...
 upd3301_t *get_safe_token_upd3301(running_device *device)
{
	assert(device != NULL);
 ...
 const upd3301_interface *get_interface_upd3301(running_device *device)
{
	assert(device != NULL);
	assert((device->type() == UPD3301));
...
{
	upd3301_t *upd3301 = get_safe_token_upd3301(device);
...
{
	upd3301_t *upd3301 = get_safe_token_upd3301(device);
	const upd3301_interface *intf = get_interface_upd3301(device);
