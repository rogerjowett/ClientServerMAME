...
*****************************************************************************/
 ...
 mc6847_state *get_safe_token_m6847(running_device *device)
{
	assert(device != NULL);
...
{
	mc6847_state *mc6847 = get_safe_token_m6847(device);
...
static int attr_index_from_attribute(running_device *device, UINT8 attr)
{
	...
	/* sanity check */
	assert(result < ARRAY_LENGTH(get_safe_token_m6847(device)->fontdata));
	return result;
}
...
static UINT8 attribute_from_attr_index(running_device *device, int attr_index)
{
	/* sanity check */
	assert(attr_index >= 0);
	assert(attr_index < ARRAY_LENGTH(get_safe_token_m6847(device)->fontdata));
