...
***************************************************************************/
 ...
 zx8301_t *get_safe_token_zx8301(running_device *device)
{
	assert(device != NULL);
 ...
 const zx8301_interface *get_interface_zx8301(running_device *device)
{
	assert(device != NULL);
...
{
	zx8301_t *zx8301 = get_safe_token_zx8301((running_device *)ptr);
...
{
	zx8301_t *zx8301 = get_safe_token_zx8301(device);
...
{
	zx8301_t *zx8301 = get_safe_token_zx8301(device);
	const zx8301_interface *intf = get_interface_zx8301(device);
