...
*****************************************************************************/
 ...
 vic3_state *get_safe_token_vic3( running_device *device )
{
	assert(device != NULL);
 ...
 const vic3_interface *get_interface_vic4567( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == VIC3));
...
{
	vic3_state *vic3 = get_safe_token_vic3(device);
