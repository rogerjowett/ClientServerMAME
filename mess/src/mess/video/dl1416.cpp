...
*****************************************************************************/
 ...
 dl1416_state *get_safe_token_dl1416(running_device *device)
{
	assert(device != NULL);
...
{
	dl1416_state *dl1416 = get_safe_token_dl1416(device);
...
{
	int i;
	dl1416_state *chip = get_safe_token_dl1416(device);
