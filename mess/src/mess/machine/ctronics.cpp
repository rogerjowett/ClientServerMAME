...
*****************************************************************************/
 ...
 centronics_state *get_safe_token_ctronics(running_device *device)
{
	assert(device != NULL);
...
{
	centronics_state *centronics = get_safe_token_ctronics(device);
...
{
	centronics_state *centronics = get_safe_token_ctronics(device->owner());
