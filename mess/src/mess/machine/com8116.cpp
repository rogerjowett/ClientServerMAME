...
***************************************************************************/
 ...
 com8116_t *get_safe_token_com8116(running_device *device)
{
	assert(device != NULL);
 ...
 const com8116_interface *get_interface_com8116(running_device *device)
{
	assert(device != NULL);
	assert((device->type() == COM8116));
...
{
	com8116_t *com8116 = get_safe_token_com8116(device);
...
{
	com8116_t *com8116 = get_safe_token_com8116(device);
	const com8116_interface *intf = get_interface_com8116(device);
	int i;
