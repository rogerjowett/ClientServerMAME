...
/*****************************************************************************
    INLINE FUNCTIONS
*****************************************************************************/
 teleprinter_state *get_safe_token_teleprinter(running_device *device)
{
	assert(device != NULL);
 ...
 const teleprinter_interface *get_interface_teleprinter(running_device *device)
{
	assert(device != NULL);
	assert(device->type() == GENERIC_TELEPRINTER);
...
{
	teleprinter_state *term = get_safe_token_teleprinter(device);
...
{
	teleprinter_state *term = get_safe_token_teleprinter((running_device *)ptr);
...
{
	teleprinter_state *term = get_safe_token_teleprinter(device);
	const teleprinter_interface *intf = get_interface_teleprinter(device);
