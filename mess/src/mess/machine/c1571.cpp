...
***************************************************************************/
 ...
 c1571_t *get_safe_token_c1571(running_device *device)
{
	assert(device != NULL);
...
{
	c1571_t *c1571 = get_safe_token_c1571(device);
...
{
	c1571_t *c1571 = get_safe_token_c1571(image.device().owner());
...
{
	c1571_t *c1571 = get_safe_token_c1571(device->owner());
