...
*****************************************************************************/
 ...
 kb_keytr_state *get_safe_token_kb_keytro(running_device *device)
{
	assert(device != NULL);
...
{
	kb_keytr_state *keytronic = get_safe_token_kb_keytro(device);
...
{
	kb_keytr_state *keytronic = get_safe_token_kb_keytro(space->cpu->owner());
