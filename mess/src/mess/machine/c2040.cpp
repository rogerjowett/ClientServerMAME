...
***************************************************************************/
 ...
 c2040_t *get_safe_token_c2040(running_device *device)
{
	assert(device != NULL);
...
{
	c2040_t *c2040 = get_safe_token_c2040(device);
...
{
	c2040_t *c2040 = get_safe_token_c2040(image.device().owner());
...
static READ8_DEVICE_HANDLER( dio_r )
{
    ...
    */
	...
	c2040_t *c2040 = get_safe_token_c2040(device->owner());
