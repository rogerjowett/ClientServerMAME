...
***************************************************************************/
 ...
 zx8302_t *get_safe_token_zx8302(running_device *device)
{
	assert(device != NULL);
 ...
 const zx8302_interface *get_interface_zx8302(running_device *device)
{
	assert(device != NULL);
...
{
	zx8302_t *zx8302 = get_safe_token_zx8302(device);
...
{
	zx8302_t *zx8302 = get_safe_token_zx8302((running_device *)ptr);
...
{
	zx8302_t *zx8302 = get_safe_token_zx8302(device);
	const zx8302_interface *intf = get_interface_zx8302(device);
	int i;
