...
***************************************************************************/
 ...
 mm74c922_t *get_safe_token_mm74c922(running_device *device)
{
	assert(device != NULL);
	return (mm74c922_t *)downcast<legacy_device_base *>(device)->token();
}

 const mm74c922_interface *get_interface_mm74c922(running_device *device)
{
	assert(device != NULL);
...
{
	mm74c922_t *mm74c922 = get_safe_token_mm74c922(device);
...
{
	mm74c922_t *mm74c922 = get_safe_token_mm74c922(device);
	const mm74c922_interface *intf = get_interface_mm74c922(device);
