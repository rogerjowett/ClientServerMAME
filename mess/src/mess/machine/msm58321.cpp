...
***************************************************************************/
 ...
 msm58321_t *get_safe_token_msm58321(running_device *device)
{
	assert(device != NULL);
 ...
 const msm58321_interface *get_interface_msm58321(running_device *device)
{
	assert(device != NULL);
...
{
	msm58321_t *msm58321 = get_safe_token_msm58321(device);
...
{
	msm58321_t *msm58321 = get_safe_token_msm58321(device);
	const msm58321_interface *intf = get_interface_msm58321(device);
