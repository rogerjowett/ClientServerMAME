...
/*****************************************************************************
    INLINE FUNCTIONS
*****************************************************************************/
 beta_disk_state *get_safe_token_beta(running_device *device)
{
	assert(device != NULL);
...
{
	beta_disk_state *beta = get_safe_token_beta(device);
...
{
	beta_disk_state *beta = get_safe_token_beta(device->owner());
