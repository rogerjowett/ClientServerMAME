...
***************************************************************************/
 ...
 ieee488_t *get_safe_token_ieee488(running_device *device)
{
	assert(device != NULL);
 ...
 const ieee488_daisy_chain *get_interface_ieee488(running_device *device)
{
	assert(device != NULL);
	assert(device->type() == IEEE488);
...
{
	ieee488_t *ieee488 = get_safe_token_ieee488(bus);
...
{
	ieee488_t *ieee488 = get_safe_token_ieee488(device);
	const ieee488_daisy_chain *daisy = get_interface_ieee488(device);
	int i;
