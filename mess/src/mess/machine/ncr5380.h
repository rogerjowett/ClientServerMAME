...
extern void ncr5380_init( running_machine *machine, const struct NCR5380interface *ncr_interface );
extern void ncr5380_exit( const struct NCR5380interface *ncr_interface );
