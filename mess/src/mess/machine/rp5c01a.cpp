...
***************************************************************************/
 ...
 rp5c01a_t *get_safe_token_rp5c01a(running_device *device)
{
	assert(device != NULL);
 ...
 const rp5c01a_interface *get_interface_rp5c01a(running_device *device)
{
	assert(device != NULL);
	assert((device->type() == RP5C01A));
...
{
//  rp5c01a_t *rp5c01a = get_safe_token_rp5c01a(device);
...
{
	rp5c01a_t *rp5c01a = get_safe_token_rp5c01a(device);
	const rp5c01a_interface *intf = get_interface_rp5c01a(device);
