...
***************************************************************************/
 ...
 i8355_t *get_safe_token_i8355(running_device *device)
{
	assert(device != NULL);
	return (i8355_t *)downcast<legacy_device_base *>(device)->token();
}

 const i8355_interface *get_interface_i8355(running_device *device)
{
	assert(device != NULL);
...
{
	i8355_t *i8355 = get_safe_token_i8355(device);
...
static DEVICE_START( i8355 )
{
	...
	const i8355_interface *intf = get_interface_i8355(device);
