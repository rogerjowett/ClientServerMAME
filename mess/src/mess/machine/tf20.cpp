...
*****************************************************************************/
 ...
 tf20_state *get_safe_token_tf20(running_device *device)
{
	assert(device != NULL);
...
{
	tf20_state *tf20 = get_safe_token_tf20(timer.owner());
...
{
	tf20_state *tf20 = get_safe_token_tf20(space->cpu->owner());
...
{
	tf20_state *tf20 = get_safe_token_tf20(device);
