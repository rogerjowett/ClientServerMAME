...
/*****************************************************************************
    INLINE FUNCTIONS
*****************************************************************************/
 terminal_state *get_safe_token_terminal(running_device *device)
{
	assert(device != NULL);
 ...
 const terminal_interface *get_interface_terminal(running_device *device)
{
	assert(device != NULL);
	assert(device->type() == GENERIC_TERMINAL);
...
{
	terminal_state *term = get_safe_token_terminal(device);
...
{
	terminal_state *term = get_safe_token_terminal((running_device *)ptr);
...
{
	terminal_state *term = get_safe_token_terminal(device);
	const terminal_interface *intf = get_interface_terminal(device);
