...
***************************************************************************/
 ...
 upd1990a_t *get_safe_token_upd1990a(running_device *device)
{
	assert(device != NULL);
 ...
 const upd1990a_interface *get_interface_upd1990a(running_device *device)
{
	assert(device != NULL);
	assert((device->type() == UPD1990A));
...
{
	upd1990a_t *upd1990a = get_safe_token_upd1990a(device);
...
{
	upd1990a_t *upd1990a = get_safe_token_upd1990a(device);
	const upd1990a_interface *intf = get_interface_upd1990a(device);
