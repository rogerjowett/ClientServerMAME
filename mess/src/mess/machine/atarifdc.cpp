...
/*****************************************************************************
    INLINE FUNCTIONS
*****************************************************************************/
 atari_fdc_t *get_safe_token_atarifdc(running_device *device)
{
	assert(device != NULL);
...
{
	atari_fdc_t *fdc = get_safe_token_atarifdc(image.device().owner());
...
{
	atari_fdc_t *fdc = get_safe_token_atarifdc(device);
