...
***************************************************************************/
 ...
 c1541_t *get_safe_token_c1541(running_device *device)
{
	assert(device != NULL);
...
static TIMER_CALLBACK( bit_tick )
{
	...
	c1541_t *c1541 = get_safe_token_c1541(device);
	int byte = 0;
...
{
	c1541_t *c1541 = get_safe_token_c1541(image.device().owner());
...
{
	c1541_t *c1541 = get_safe_token_c1541(device->owner());
