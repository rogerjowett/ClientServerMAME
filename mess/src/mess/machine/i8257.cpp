...
***************************************************************************/
 ...
 i8257_t *get_safe_token_i8257(running_device *device)
{
	assert(device != NULL);
 ...
 const i8257_interface *get_interface_i8257(running_device *device)
{
	assert(device != NULL);
	assert((device->type() == I8257));
...
{
	i8257_t *i8257 = get_safe_token_i8257(device);
