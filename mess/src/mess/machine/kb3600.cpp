...
***************************************************************************/
 ...
 ay3600_t *get_safe_token_kb3600(running_device *device)
{
	assert(device != NULL);
 ...
 const ay3600_interface *get_interface_kb3600(running_device *device)
{
	assert(device != NULL);
...
static TIMER_CALLBACK( ay3600_scan_tick )
{
	...
	ay3600_t *ay3600 = get_safe_token_kb3600(device);
	const ay3600_interface *intf = get_interface_kb3600(device);
