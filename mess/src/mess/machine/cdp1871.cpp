...
***************************************************************************/
 ...
 cdp1871_t *get_safe_token_cdp1871(running_device *device)
{
	assert(device != NULL);
 ...
 const cdp1871_interface *get_interface_cdp1871(running_device *device)
{
	assert(device != NULL);
...
{
	cdp1871_t *cdp1871 = get_safe_token_cdp1871(device);
...
{
	cdp1871_t *cdp1871 = get_safe_token_cdp1871(device);
	const cdp1871_interface *intf = get_interface_cdp1871(device);
