...
struct _dev_harddisk_t
{
 ...
 dev_harddisk_t *get_safe_token_harddriv(running_device *device)
{
	assert( device != NULL );
...
{
	dev_harddisk_t	*harddisk = get_safe_token_harddriv( &image.device() );
...
{
	dev_harddisk_t	*harddisk = get_safe_token_harddriv( image );
	int our_result;
...
{
	dev_harddisk_t	*harddisk = get_safe_token_harddriv( device );
