...
struct _upd1771_state
{
 ...
 upd1771_state *get_safe_token_upd1771(running_device *device)
{
    assert(device != NULL);
...
{
    upd1771_state *state = get_safe_token_upd1771( device );
...
{
	upd1771_state *upd1771 = get_safe_token_upd1771( device );
