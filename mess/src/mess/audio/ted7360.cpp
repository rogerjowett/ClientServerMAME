...
*****************************************************************************/
 ...
 ted7360_state *get_safe_token_ted7360( running_device *device )
{
	assert(device != NULL);
 ...
 const ted7360_interface *get_interface_ted7360( running_device *device )
{
	assert(device != NULL);
	assert(device->type() == SOUND_TED7360);
...
{
	ted7360_state *ted7360 = get_safe_token_ted7360(device);
