...
extern void am53cf96_init( running_machine *machine, const struct AM53CF96interface *am_interface );
extern void am53cf96_exit( const struct AM53CF96interface *am_interface );
