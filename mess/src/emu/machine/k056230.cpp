...
INLINE k056230_state *k056230_get_safe_token_k056230( running_device *device )
{
	assert(device != NULL);
...
INLINE const k056230_interface *k056230_get_interface_k056230( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == K056230));
...
{
	k056230_state *k056230 = k056230_get_safe_token_k056230(device);
...
{
	k056230_state *k056230 = k056230_get_safe_token_k056230(device);
	const k056230_interface *intf = k056230_get_interface_k056230(device);
