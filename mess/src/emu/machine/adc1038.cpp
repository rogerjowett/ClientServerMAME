...
INLINE adc1038_state *adc1038_get_safe_token_adc1038( running_device *device )
{
	assert(device != NULL);
...
INLINE const adc1038_interface *adc1038_get_interface_adc1038( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == ADC1038));
...
{
	adc1038_state *adc1038 = adc1038_get_safe_token_adc1038(device);
...
{
	adc1038_state *adc1038 = adc1038_get_safe_token_adc1038(device);
	const adc1038_interface *intf = adc1038_get_interface_adc1038(device);
