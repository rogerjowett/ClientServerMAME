...
***************************************************************************/
 ...
 adc12138_state *get_safe_token_adc1213x(running_device *device)
{
	assert(device != NULL);
 ...
 const adc12138_interface *get_interface_adc1213x(running_device *device)
{
	assert(device != NULL);
	assert((device->type() == ADC12130) || (device->type() == ADC12132) || (device->type() == ADC12138));
...
{
	adc12138_state *adc1213x = get_safe_token_adc1213x(device);
...
{
	adc12138_state *adc1213x = get_safe_token_adc1213x(device);
	const adc12138_interface *intf = get_interface_adc1213x(device);
