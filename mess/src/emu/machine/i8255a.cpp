...
***************************************************************************/
 ...
 i8255a_t *get_safe_token_i8255a(running_device *device)
{
	assert(device != NULL);
 ...
 const i8255a_interface *get_interface_i8255a(running_device *device)
{
	assert(device != NULL);
...
{
	i8255a_t *i8255a = get_safe_token_i8255a(device);
...
{
	i8255a_t *i8255a = get_safe_token_i8255a(device);
	const i8255a_interface *intf = get_interface_i8255a(device);
