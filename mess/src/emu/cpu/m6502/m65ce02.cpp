...
struct	_m65ce02_Regs {
 ...
 m65ce02_Regs *get_safe_token_m65ce02(running_device *device)
{
	assert(device != NULL);
...
{
	m65ce02_Regs *cpustate = get_safe_token_m65ce02(device);
...
{
	m65ce02_Regs *cpustate = (device != NULL && device->token() != NULL) ? get_safe_token_m65ce02(device) : NULL;
