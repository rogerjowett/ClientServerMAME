...
***************************************************************************/
 ...
 powerpc_state *get_safe_token_ppcdrc(running_device *device)
{
	assert(device != NULL);
...
{
	powerpc_state *ppc = get_safe_token_ppcdrc(device);
...
{
	powerpc_state *ppc = (device != NULL && device->token() != NULL) ? get_safe_token_ppcdrc(device) : NULL;
	switch (state)
	{
