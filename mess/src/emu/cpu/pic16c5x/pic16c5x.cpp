...
struct _pic16c5x_state
{
 ...
 pic16c5x_state *get_safe_token_pic16c5x(running_device *device)
{
	assert(device != NULL);
...
{
	pic16c5x_state *cpustate = get_safe_token_pic16c5x(device);
...
{
	pic16c5x_state *cpustate = get_safe_token_pic16c5x(cpu);
...
{
	pic16c5x_state *cpustate = (device != NULL && device->token() != NULL) ? get_safe_token_pic16c5x(device) : NULL;
