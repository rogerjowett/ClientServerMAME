...
***************************************************************************/
 ...
 am29000_state *get_safe_token_am29000(running_device *device)
{
	assert(device != NULL);
...
{
	am29000_state *am29000 = get_safe_token_am29000(device);
...
{
	am29000_state *am29000 = (device != NULL && device->token() != NULL) ? get_safe_token_am29000(device) : NULL;
