...
typedef struct {
 ...
 tms57002_t *get_safe_token_tms57002(running_device *device)
{
	assert(device != NULL);
...
{
	tms57002_t *s = get_safe_token_tms57002(device);
	UINT8 olds = s->sti;
...
{
	tms57002_t *s = (device != NULL && device->token() != NULL) ? get_safe_token_tms57002(device) : NULL;
