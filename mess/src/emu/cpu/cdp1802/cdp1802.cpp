...
***************************************************************************/
 ...
 cdp1802_state *get_safe_token_cdp1802(running_device *device)
{
	assert(device != NULL);
...
{
	cdp1802_state *cpustate = get_safe_token_cdp1802(device);
...
{
	cdp1802_state *cpustate = (device != NULL && device->token() != NULL) ? get_safe_token_cdp1802(device) : NULL;
