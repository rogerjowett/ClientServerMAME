...
struct _tms7000_state
{
 ...
 tms7000_state *get_safe_token_tms7000(running_device *device)
{
	assert(device != NULL);
...
{
	tms7000_state *cpustate = get_safe_token_tms7000(device);
...
{
	tms7000_state *cpustate = (device != NULL && device->token() != NULL) ? get_safe_token_tms7000(device) : NULL;
...
{
	tms7000_state *cpustate = get_safe_token_tms7000(space->cpu);
