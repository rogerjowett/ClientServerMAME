...
{
	m37710i_cpu_struct *cpustate = get_safe_token_m37710(space->cpu);
...
{
	m37710i_cpu_struct *cpustate = get_safe_token_m37710(device);
...
{
	m37710i_cpu_struct *m37710 = get_safe_token_m37710(device);
...
CPU_GET_INFO( m37710 )
{
	m37710i_cpu_struct *cpustate = (device != NULL && device->token() != NULL) ? get_safe_token_m37710(device) : NULL;
