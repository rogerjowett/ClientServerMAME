...
inline sh4_state *get_safe_token_sh4comn(running_device *device)
{
	assert(device != NULL);
...
{
	sh4_state *sh4 = get_safe_token_sh4comn(space->cpu);
	int a;
...
{
	sh4_state *sh4 = get_safe_token_sh4comn(device);
