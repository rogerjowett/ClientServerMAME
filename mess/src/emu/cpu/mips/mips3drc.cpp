...
***************************************************************************/
 ...
 mips3_state *get_safe_token_mips3drc(running_device *device)
{
	assert(device != NULL);
...
{
	mips3_state *mips3 = get_safe_token_mips3drc(device);
...
{
	mips3_state *mips3 = (device != NULL && device->token() != NULL) ? get_safe_token_mips3drc(device) : NULL;
	switch (state)
	{
