...
{
	dsp56k_core* cpustate = get_safe_token_dsp56k(device);
...
CPU_GET_INFO( dsp56k )
{
	dsp56k_core* cpustate = (device != NULL && device->token() != NULL) ? get_safe_token_dsp56k(device) : NULL;
