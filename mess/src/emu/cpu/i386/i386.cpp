...
#include "i386ops.cpp"
#include "i386op16.cpp"
#include "i386op32.cpp"
#include "i486ops.cpp"
#include "pentops.cpp"
#include "x87ops.cpp"
#include "i386ops.h"
...
static UINT64 i386_debug_segbase(void *globalref, void *ref, UINT32 params, const UINT64 *param)
{
	...
	i386_state *cpustate = get_safe_token_i386(device);
	UINT32 result;
	I386_SREG seg;
...
CPU_GET_INFO( i386 )
{
	i386_state *cpustate = (device != NULL && device->token() != NULL) ? get_safe_token_i386(device) : NULL;
