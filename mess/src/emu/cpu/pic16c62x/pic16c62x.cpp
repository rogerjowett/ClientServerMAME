...
struct _pic16c62x_state
{
 ...
 pic16c62x_state *get_safe_token_pic16c62x(running_device *device)
{
	assert(device != NULL);
...
{
	pic16c62x_state *cpustate = get_safe_token_pic16c62x(device);
...
{
	pic16c62x_state *cpustate = get_safe_token_pic16c62x(cpu);
...
{
	pic16c62x_state *cpustate = (device != NULL && device->token() != NULL) ? get_safe_token_pic16c62x(device) : NULL;
