...
struct _sn76496_state
{
 ...
 sn76496_state *get_safe_token_sn76496(running_device *device)
{
	assert(device != NULL);
...
{
	sn76496_state *R = get_safe_token_sn76496(device);
...
{
	sn76496_state *chip = get_safe_token_sn76496(device);
