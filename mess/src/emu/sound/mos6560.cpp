...
*****************************************************************************/
 ...
 mos6560_state *get_safe_token_mos6560( running_device *device )
{
	assert(device != NULL);
 ...
 const mos6560_interface *get_interface_mos6560( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == MOS656X));
...
{
	mos6560_state *mos6560 = get_safe_token_mos6560(device);
	int y, code;
