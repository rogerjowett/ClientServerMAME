...
INLINE k056800_state *k056800_get_safe_token_k056800( running_device *device )
{
	assert(device != NULL);
...
INLINE const k056800_interface *k056800_get_interface_k056800( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == K056800));
...
{
	k056800_state *k056800 = k056800_get_safe_token_k056800(device);
...
{
	k056800_state *k056800 = k056800_get_safe_token_k056800(device);
	const k056800_interface *intf = k056800_get_interface_k056800(device);
