...
*****************************************************************************/
 ...
 hd63484_state *get_safe_token_hd63484( running_device *device )
{
	assert(device != NULL);
 ...
 const hd63484_interface *get_interface_hd63484( running_device *device )
{
	assert(device != NULL);
	assert(device->type() == HD63484);
...
{
	hd63484_state *hd63484 = get_safe_token_hd63484(device);
	INT16 ax,ay;
...
{
	hd63484_state *hd63484 = get_safe_token_hd63484(device);
	const hd63484_interface *intf = get_interface_hd63484(device);
