...
INLINE tc0220ioc_state *tc0220ioc_get_safe_token_taitoio( running_device *device )
{
	assert(device != NULL);
...
INLINE const tc0220ioc_interface *tc0220ioc_get_interface_taitoio( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == TC0220IOC));
...
{
	tc0220ioc_state *tc0220ioc =  tc0220ioc_get_safe_token_taitoio(device);
...
{
	tc0220ioc_state *tc0220ioc =  tc0220ioc_get_safe_token_taitoio(device);
	const tc0220ioc_interface *intf = tc0220ioc_get_interface_taitoio(device);
...
INLINE tc0510nio_state *tc0510nio_get_safe_token_taitoio( running_device *device )
{
	assert(device != NULL);
...
INLINE const tc0510nio_interface *tc0510nio_get_interface_taitoio( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == TC0510NIO));
...
{
	tc0510nio_state *tc0510nio = tc0510nio_get_safe_token_taitoio(device);
...
{
	tc0510nio_state *tc0510nio =  tc0510nio_get_safe_token_taitoio(device);
	const tc0510nio_interface *intf = tc0510nio_get_interface_taitoio(device);
...
INLINE tc0640fio_state *tc0640fio_get_safe_token_taitoio( running_device *device )
{
	assert(device != NULL);
...
INLINE const tc0640fio_interface *tc0640fio_get_interface_taitoio( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == TC0640FIO));
...
{
	tc0640fio_state *tc0640fio = tc0640fio_get_safe_token_taitoio(device);
...
{
	tc0640fio_state *tc0640fio =  tc0640fio_get_safe_token_taitoio(device);
	const tc0640fio_interface *intf = tc0640fio_get_interface_taitoio(device);
