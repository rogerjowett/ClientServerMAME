...
struct _namco_06xx_state
{
 ...
 namco_06xx_state *get_safe_token_namco06(running_device *device)
{
	assert(device != NULL);
...
{
	namco_06xx_state *state = get_safe_token_namco06((running_device *)ptr);
...
{
	namco_06xx_state *state = get_safe_token_namco06(device);
	UINT8 result = 0xff;
	int devnum;
