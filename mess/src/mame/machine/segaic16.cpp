...
INLINE ic_315_5248_state *_315_5248_get_safe_token_segaic16( running_device *device )
{
	assert(device != NULL);
...
{
	ic_315_5248_state *ic_315_5248 = _315_5248_get_safe_token_segaic16(device);
...
INLINE ic_315_5249_state *_315_5249_get_safe_token_segaic16( running_device *device )
{
	assert(device != NULL);
...
{
	ic_315_5249_state *ic_315_5249 = _315_5249_get_safe_token_segaic16(device);
...
INLINE ic_315_5250_state *_315_5250_get_safe_token_segaic16( running_device *device )
{
	assert(device != NULL);
...
INLINE const ic_315_5250_interface *_315_5250_get_interface_segaic16( running_device *device )
{
	assert(device != NULL);
	assert((device->type() == _315_5250));
...
{
	ic_315_5250_state *ic_315_5250 = _315_5250_get_safe_token_segaic16(device);
...
{
	ic_315_5250_state *ic_315_5250 = _315_5250_get_safe_token_segaic16(device);
	const ic_315_5250_interface *intf = _315_5250_get_interface_segaic16(device);
