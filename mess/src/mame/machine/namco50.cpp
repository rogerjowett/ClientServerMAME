...
struct _namco_50xx_state
{
 ...
 namco_50xx_state *get_safe_token_namco50(running_device *device)
{
	assert(device != NULL);
...
{
	namco_50xx_state *state = get_safe_token_namco50((running_device *)ptr);
...
{
	namco_50xx_state *state = get_safe_token_namco50(space->cpu->owner());
...
{
	namco_50xx_state *state = get_safe_token_namco50(device);
